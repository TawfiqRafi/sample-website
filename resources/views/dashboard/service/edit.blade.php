...
@section('content')
    <div class="box">
        <div class="box-header with-action">
            <h5 class="box-title">Update Service</h5>
            <a href="{{ route('service.list') }}" class="btn btn-sm btn-secondary float-right">Service List</a>
        </div>
        {!! Form::open(['route' => ['service.update', $service->slug], 'method' => 'PUT']) !!}
        <div class="box-body">
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <center>
                        ...
                        src="{{asset($service['image'])}}" onerror="this.src='{{ asset('assets/frontend/img/img2.jpg')}}'" alt="service image" />
                    </center>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <input type="text" name="title" id="title" placeholder="Enter title" class="form-control" value="{{ $service['title'] }}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                    <textarea type="text" name="short_description" id="" placeholder="Enter short description"
                        class="form-control">{{ $service['short_description'] }}</textarea>
