                ...
                <div class="row g-5">
                    <div class="col-lg-7">
                        <div class="section-title position-relative pb-3 mb-5">
                            ...
                            <h1 class="mb-0">{{ $about?$about->title:'' }}</h1>
                        </div>
                        <div class="mb-4">{!! $about?Str::limit($about->content, 350, ''):'' !!}</div>
                        <a href="{{ route('about-us') }}" class="btn btn-primary py-3 px-5 mt-3 wow zoomIn" data-wow-delay="0.9s">Read More...</a>
                    </div>
                    <div class="col-lg-5" style="min-height: 500px;">
                        <div class="position-relative h-100">
                            <img class="position-absolute w-100 h-100 rounded wow zoomIn" data-wow-delay="0.9s" src="{{ $about?asset($about->image):'' }}" style="object-fit: cover;">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.9s">
                    <div class="position-relative bg-primary rounded h-100 d-flex flex-column align-items-center justify-content-center text-center p-5">
                        ...
                        <h2 class="text-white mb-0">{{ $settings ? $settings->phone : '' }}</h2>
                    </div>
                </div>
            </div>
        </div>
